"""
Django settings for chronosphere_drf_api project.
...
ALLOWED_HOSTS = ['localhost',
                 'https://ci-pp5-chronosphere-fae2dfb25e8d.herokuapp.com/']
...
WSGI_APPLICATION = 'chronosphere_drf_api.wsgi.application'
